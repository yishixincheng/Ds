 ...
 **/
 ...
 var CONFIG={
		  ...
		  fs.forEach(function(f){
		   ...
		   if(Ds.isFunction(cb)){
			    ...
			    var _selfcall=function(fa){
				     var fn=fa.shift();
					 if(Ds.isEmpty(fn)){cb.call(obj,odoms);return;}
  ...
  Ds.alert=function(tip,type,time,func){
	  return Ds.dcom.callc("sys-alert","open",{tip:tip,type:type||'',time:time||2000,func:func||null});
  };
  //ajax请求
  Ds.request=function(u,d,dt,t,s,a,st){
	  Ds.dcom.callc("sys-request","open",{u:u,d:d||{},dt:dt||'',t:t||'get',s:s||null,a:a,st:st||1});
  };
